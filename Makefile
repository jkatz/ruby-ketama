...
INCFLAGS = -I. -I. -I/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/1.8/universal-darwin9.0 -Iext
CPPFLAGS =  
CXXFLAGS = $(CFLAGS) 
...
target_prefix = 
LOCAL_LIBS = 
LIBS = $(LIBRUBYARG_SHARED) -lketama  -lpthread -ldl -lm  
SRCS = ruby-ketama.c
OBJS = ruby-ketama.o
TARGET = ketama
DLLIB = $(TARGET).bundle
